...
from gekitchen.erd.values.common import ErdPresent
from gekitchen.erd.values.fridge import HotWaterStatus, ErdHotWaterStatus, ErdFullNotFull, ErdPodStatus
