...
_configuration = [
    ...
    ErdConfigurationEntry(ErdCode.LAUNDRY_DOOR_LOCK, LaundryDoorLockStatusConverter(), ErdCodeClass.LOCK_CONTROL),
    ErdConfigurationEntry(ErdCode.LAUNDRY_REMOTE_STATUS, RemoteStatusConverter(), ErdCodeClass.LAUNDRY_SENSOR),
    ErdConfigurationEntry(ErdCode.LAUNDRY_DELAY_TIME_REMAINING, ErdTimeRemainingConverter(), ErdCodeClass.LAUNDRY_SENSOR),
