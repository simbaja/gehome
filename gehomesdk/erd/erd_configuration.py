...
_configuration = [
    ...
    ErdConfigurationEntry(ErdCode.LAUNDRY_WASHER_BULK_TANK_SIZE, SmartDispenseTankSizeConverter(), ErdCodeClass.COUNTER, ErdDataType.FLOAT),
    ...
    ErdConfigurationEntry(ErdCode.LAUNDRY_WASHER_SMART_DISPENSE_BECAME_LOW_AT_END_OF_CYCLE, ErdReadOnlyIntConverter(), ErdCodeClass.COUNTER, ErdDataType.INT),
    ...
    ErdConfigurationEntry(ErdCode.WH_HEATER_BOOST_STATE, ErdOnOffConverter(), ErdCodeClass.WATERHEATER_SENSOR),
