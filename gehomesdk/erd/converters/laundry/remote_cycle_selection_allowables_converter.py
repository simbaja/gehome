...
from gehomesdk.erd.values.laundry import ErdRemoteCycleSelectionAllowables

_LOGGER = logging.getLogger(__name__)

class ErdRemoteCycleSelectionAllowablesConverter(ErdReadOnlyConverter[ErdRemoteCycleSelectionAllowables]):
    def erd_decode(self, value: str) -> ErdRemoteCycleSelectionAllowables:
        if not value:
        ...
        try:
            ...
            _LOGGER.exception("Could not construct remote cycle selection allowables, using default.")
            return ErdRemoteCycleSelectionAllowables(raw_value=value)
